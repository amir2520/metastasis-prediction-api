...
from metastatic.utils.utils import get_best_run, get_client
from metastatic.utils.utils import get_logger
...
class MetricComparer:
    ...
    def is_metric_better(self, run: Run, best_run_data: dict[str, Any]) -> bool:
        ...
        print(f"best_run_data keys: {best_run_data.keys()}")
        print(f"Looking for: metrics.{self.metric_name}")
